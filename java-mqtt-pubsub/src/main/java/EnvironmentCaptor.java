...
public class EnvironmentCaptor implements Serializable{
    ...
    public String toString() { return "Luminosité : "+this.brightness+". Heure : "+this.hour+" Présence : "+getPresence();}

    public int getHour() { return this.hour; }

    public String presenceToString () { return getPresence() ? "true" : "false";}
